# HashVektor v0.8.2 — Proprietary Edition
...
This is the **official proprietary release** of HashVektor v0.8.2.
...
HashVektor v0.8.2 uses **offline per‑machine activation**.
...
1. Launch `HashVektor_v0.8.2.exe`
...
The latest release of HashVektor v0.8.2 is available on:
...
- SHA‑256 checksum of `HashVektor_v0.8.2.exe`:
    `5c7437a8f26517452df59178d1685deaa49eb200b964312c2268cc61a358e0d5`
- Size: `838.34 KB`
- Version number: `0.8.2`
- VirusTotal Scan:
    - [`HashVektor_v0.8.2.exe`](https://www.virustotal.com/gui/file/5c7437a8f26517452df59178d1685deaa49eb200b964312c2268cc61a358e0d5?nocache=1)
