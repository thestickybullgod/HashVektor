# HashVektor v1.5 — Proprietary Edition
...
This is the **official proprietary release** of HashVektor v1.5.
...
HashVektor v1.5 uses **offline per‑machine activation**.
...
The latest release of HashVektor v1.5 is available on:
